...
/***********************************************
 *send_response
   - helper function that contains shared logic needed by both
     return_result() and return_error(). Writes response to client.
   - parameters are passed by return_result or return_error
